...
grep '?ref=8b7093ac5b240e72edceac5224be3d7605bc8957' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8b7093ac5b240e72edceac5224be3d7605bc8957/${root}\/\2/g" "${file}"
done

...
grep '?ref=97ac28963a8e86054ced1884a04e241d53dfcdd4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=97ac28963a8e86054ced1884a04e241d53dfcdd4/${root}\/\2/g" "${file}"
done
